    ...
    if(nameChecker()===true){
        ...
        if(userEmailChecker()===true){
              ...
              if(phoneChecker()===true){
                ...
                document.getElementById("mylocation1").innerHTML="";
                document.getElementById("mylocation").innerHTML="";
                      document.getElementById("numPhone").innerHTML="*enter valid PhoneNumber....!";
                      document.getElementById("telNo").style.border="3px solid #FF0000";
                       return false;
                    }
        }else{

             document.getElementById("userEmail1").innerHTML="You have entered an invalid email address!";
             document.getElementById("userEmail").style.border="3px solid #FF0000";
             return false;
        }
    }else{
        
        document.getElementById("fullName").innerHTML="*Invalid Name";
        document.getElementById("fulluserName").style.border="3px solid #FF0000";
             ...
             if (matches[0].length>=4 && matches[1].length>=4) {
                       ...
                       if(userName.match(/^[a-zA-Z]+( [a-zA-Z]+)*$/)){
                        ...
                        return true;
                           ...
                           document.getElementById("fullName").innerHTML="*spaces not allowed";
                           return false;
                                   }
                 } else{
